...
type NullableProperties struct {
	...
	OptionalAndNullable oapiCodegenTypesPkg.Nullable[string] `form:"optionalAndNullable,omitempty" json:"optionalAndNullable,omitempty"`
	Required            string                               `form:"required" json:"required"`
	RequiredAndNullable oapiCodegenTypesPkg.Nullable[string] `form:"requiredAndNullable" json:"requiredAndNullable"`
}
